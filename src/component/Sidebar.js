...
const Sidebar = (props) => {
    return(<>
        <aside id="logo-sidebar" className={"flex fixed top-0 left-0 z-20 flex-col flex-shrink-0 pt-16 h-full duration-75 border-r border-gray-200 lg:flex transition-width dark:border-gray-700" + (!props.props ? ' hidden' : '') + (props.props ? ' w-16' : ' w-64')} aria-label="Sidebar">
            <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul className="space-y-2">
                    <li>
                        ...
                        <span className="ml-3">Obligor</span>
                        </Link>
                    </li>
                    {/* <li>
